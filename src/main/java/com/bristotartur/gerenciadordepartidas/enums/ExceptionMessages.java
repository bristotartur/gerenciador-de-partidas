...
public enum ExceptionMessages {
    ...
    CANNOT_CREATE_MATCH("Partidas não podem ser criadas em eventos já encerrados."),
    CANNOT_UPDATE_MATCH("Partidas só podem ser atualizadas em eventos sob o status 'IN_PROGRESS.'"),
