...
public interface PenaltyCardMapper {
    ...
    PenaltyCard toNewPenaltyCard(PenaltyCardDto penaltyCardDto, Participant player, MatchSport matchSport);
    ...
    @Mapping(target = "color", source = "penaltyCardDto.color.name")
    PenaltyCard toExistingPenaltyCard(Long id, PenaltyCardDto penaltyCardDto, Participant player, MatchSport matchSport);
